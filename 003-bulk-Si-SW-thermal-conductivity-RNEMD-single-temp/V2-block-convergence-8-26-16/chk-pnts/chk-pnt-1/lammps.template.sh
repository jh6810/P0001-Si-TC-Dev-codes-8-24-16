...
variable rep_x equal REP_C_IN   	#repeat lattice this many times in given direction
variable rep_y equal REP_Y_IN  	#repeat lattice this many times in given direction
variable rep_z equal REP_C_IN   	#repeat lattice this many times in given direction
...
variable N_TC_EQ equal 5*NUM_ATOMS_IN
variable N_TC equal 25*NUM_ATOMS_IN

variable swap_every equal 100
variable TC_num_layers equal NUM_LAYERS_IN 
...
##Nevery=2, Nrepeat=6, and Nfreq=100, then values on timesteps 90,92,94,96,98,100
fix ave_press all ave/time 1 ${N_PROD_NVT} ${N_PROD_NVT} v_Pxx v_Pyy v_Pzz v_Pxy v_Pxz v_Pyz  file  ${LOC1}/NVT-ave-pressure-REP_C_IN-REP_Y_IN.dat 

run ${N_PROD_NVT} 

write_data ${LOC1}/NVT-EQ-STRUCTURE-REP_C_IN-REP_Y_IN #data file
...
log ${LOC2}/log-TC-eq-REP_C_IN-REP_Y_IN  #save TD output to this file	
...
##READ ATOMS
read_data ${LOC1}/NVT-EQ-STRUCTURE-REP_C_IN-REP_Y_IN
velocity all create ${T} 4928459 rot yes mom yes dist gaussian
...
write_data ${LOC2}/TC-EQ-STRUCTURE-REP_C_IN-REP_Y_IN #data file
clear 
...
log ${LOC2}/log-TC-prod-REP_C_IN-REP_Y_IN  #save TD output to this file	
...
###READ ATOMS
read_data ${LOC2}/TC-EQ-STRUCTURE-REP_C_IN-REP_Y_IN
...
fix 3 all ave/chunk 1 ${N_TC} ${N_TC} layers v_temp1 file ${LOC2}/TC-TEMP-PROFILE-REP_C_IN-REP_Y_IN

thermo ${thermo_save}

variable A equal lx*lz
variable flux equal f_1/((time-0.000000000001)*v_A) #ADD -0.000001 to avoid division by zero
thermo_style custom time temp v_flux

run ${N_TC} 

print ${flux} file ${LOC2}/flux-REP_C_IN-REP_Y_IN.dat
